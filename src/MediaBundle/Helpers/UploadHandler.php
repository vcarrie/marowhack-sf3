...
//                )
    ...
    protected function gd_get_image_object($file_path, $func, $no_cache = true)
    {
...
//        On met l'option de cache par défaut à true sinon ca utilise les valeurs précédentes et c'est nul
...
//        );
    ...
    protected function imagick_get_image_object($file_path, $no_cache = true)
    {
        if (empty($this->image_objects[$file_path]) || $no_cache) {
    ...
    protected function generate_unique_filename($filename = "")
    {
        ...
        return md5(date('Y-m-d H:i:s:u').$filename) . $extension;
    }
