...
class FileManager
{
    ...
    public function getParent()
    {
        ...
        $parentRoute = $this->router->generate('media', $queryParentParameters);
    ...
    {
        if(!is_dir($this->getConfiguration()['dir'])){
            mkdir($this->getConfiguration()['dir'], 0775, true);
        }
//        var_dump($this->getConfiguration()['dir']);die;
